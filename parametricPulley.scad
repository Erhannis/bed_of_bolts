...
// Functions
// ---------
function tooth_spaceing_curvefit (b,c,d,number_of_teeth=number_of_teeth0)
  = ((c * pow(number_of_teeth,d)) / (b + pow(number_of_teeth,d))) * number_of_teeth ;

function tooth_spacing(tooth_pitch,pitch_line_offset,number_of_teeth=number_of_teeth0)
  = (2*((number_of_teeth*tooth_pitch)/(3.14159265*2)-pitch_line_offset)) ;

function pulley_height() = base_height + toothed_part_length + idler_height + retainer_height;
  
// ================================================================================
// Main Module
// ================================================================================
module pulley( belt_type , pulley_OD , tooth_depth , tooth_width, number_of_teeth=number_of_teeth0, cutouts=true ){
